...
--
-- Ref: https://github.com/chrisant996/clink-fzf
--
...
-- Changed hight from 40% to 80%
settings.add('fzf.height', '80%', 'Height to use for the --height flag')
...
os.setenv('FZF_ALT_C_OPTS', '--preview "pwsh -NoProfile -NonInteractive -NoLogo -File ' .. fzf_preview_script .. ' . {}" --bind "ctrl-/:change-preview-window(down|hidden|),alt-up:preview-page-up,alt-down:preview-page-down,ctrl-s:toggle-sort"')
