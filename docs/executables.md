...
| `git-gh-get` | Download a file or directory from GitHub, GitLab, Forgejo, or Gitea without cloning the full repository. Accepts native URLs and forge-qualified paths; dry runs emit TSV or Gum-formatted Markdown tables. |
